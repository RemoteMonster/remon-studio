      ...
      <v-app>
        ...
        <v-content>
          <v-container fluid fill-height>
            <video id='remoteVideo1' style='z-index:9; position:absolute; width:80%; height:80%; overflow:auto;' autoplay controls muted v-bind:style='{ visibility: remoteVideoVisibility, display:remoteVideoDisplay }'></video>
